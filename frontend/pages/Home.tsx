    ...
    <>
      <main className="flex-grow flex flex-col items-center justify-center relative w-full overflow-hidden">
        ...
        <div className="w-full max-w-[1200px] px-4 sm:px-6 lg:px-8 py-20 flex flex-col items-center gap-12 relative z-10">
          {/* Hero Text */}
          <div className="flex flex-col items-center text-center gap-6 max-w-3xl animate-fadeIn">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-surface-dark border border-surface-border mb-2">
              <span className="w-2 h-2 rounded-full bg-green-500 animate-pulse"></span>
              <span className="text-xs font-medium text-slate-400 uppercase tracking-wider">MOI Mainnet Live</span>
            </div>
            <h1 className="text-4xl md:text-6xl font-black leading-[1.1] tracking-tight bg-gradient-to-b from-white to-white/60 bg-clip-text text-transparent">
          ...
          {/* Search Component */}
          <div className="w-full max-w-2xl group animate-[fadeIn_0.8s_ease-out_0.2s_both]">
            <div className="relative flex items-center w-full h-16 rounded-xl bg-surface-dark border border-surface-border shadow-xl shadow-black/20 focus-within:ring-2 focus-within:ring-primary/50 focus-within:border-primary transition-all duration-300">
              ...
              <div className="pr-2 hidden sm:block">
                <button className="h-10 px-4 rounded-lg bg-surface-border/50 text-xs font-bold text-slate-400 hover:text-white hover:bg-primary transition-all">
                  ⌘K
                </button>
              </div>
            </div>
          ...
          <div className="animate-[fadeIn_1s_ease-out_0.4s_both]">
            <Link to="/discovery" className="group flex flex-col items-center gap-2 text-slate-400 hover:text-primary transition-colors">
              <span className="text-sm font-bold tracking-wide">View Network Activity</span>
              <span className="material-symbols-outlined text-xl animate-bounce group-hover:translate-y-1 transition-transform">arrow_downward</span>
            </Link>
          </div>
        </div>
      </main>
      ...
      <section className="w-full bg-[#0e1518] border-t border-surface-border py-16">
