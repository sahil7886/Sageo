        ...
        <form className="flex flex-col gap-6" onSubmit={(e) => e.preventDefault()}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <label className="flex flex-col gap-2">
              ...
              <div className="relative">
                <input className="w-full bg-surface-dark border border-surface-border rounded-lg h-12 px-4 text-white placeholder:text-text-secondary/50 focus:border-primary focus:ring-1 focus:ring-primary focus:outline-none transition-all" placeholder="e.g. Sageo Research Bot" type="text" />
              </div>
            </label>
            <label className="flex flex-col gap-2">
              <div className="flex justify-between">
              ...
              <input className="w-full bg-surface-dark border border-surface-border rounded-lg h-12 px-4 text-white placeholder:text-text-secondary/50 focus:border-primary focus:ring-1 focus:ring-primary focus:outline-none transition-all" placeholder="1.0.0" type="text" />
            </label>
          </div>
          ...
          <label className="flex flex-col gap-2">
            ...
            <div className="relative flex items-center">
              ...
              <input className="w-full bg-surface-dark border border-surface-border rounded-lg h-12 pl-12 pr-4 text-white placeholder:text-text-secondary/50 focus:border-primary focus:ring-1 focus:ring-primary focus:outline-none transition-all" placeholder="https://" type="url" />
            </div>
          </label>
          ...
          <label className="flex flex-col gap-2">
            ...
            <textarea className="w-full bg-surface-dark border border-surface-border rounded-lg p-4 text-white placeholder:text-text-secondary/50 focus:border-primary focus:ring-1 focus:ring-primary focus:outline-none resize-none transition-all" placeholder="An autonomous agent capable of analyzing complex market data trends..." rows={2}></textarea>
          </label>
          ...
          <label className="flex flex-col gap-2">
            ...
            <div className="w-full bg-surface-dark border border-surface-border rounded-lg min-h-[56px] p-2 flex flex-wrap gap-2 focus-within:border-primary focus-within:ring-1 focus-within:ring-primary transition-all cursor-text">
              <div className="flex items-center gap-1 bg-surface-border text-white text-xs font-medium px-3 py-1.5 rounded-full border border-[#3c4d53]">
                <span>Data Analysis</span>
                <button className="hover:text-red-400 flex items-center"><span className="material-symbols-outlined text-[14px]">close</span></button>
              </div>
              <div className="flex items-center gap-1 bg-surface-border text-white text-xs font-medium px-3 py-1.5 rounded-full border border-[#3c4d53]">
                <span>LLM Integration</span>
                <button className="hover:text-red-400 flex items-center"><span className="material-symbols-outlined text-[14px]">close</span></button>
              </div>
              <input className="bg-transparent border-none text-white text-sm focus:ring-0 p-1.5 placeholder:text-text-secondary/50 flex-1 min-w-[120px]" placeholder="Type and press enter..." type="text" />
            </div>
          ...
          <div className="flex flex-col-reverse md:flex-row justify-between gap-4 items-center">
            ...
            <div className="flex gap-4 w-full md:w-auto">
              <button className="flex-1 md:flex-none min-w-[120px] rounded-lg border border-surface-border bg-surface-dark text-white text-sm font-bold h-12 hover:bg-surface-border/80 transition-colors">
                Save Draft
              </button>
              <button className="flex-1 md:flex-none min-w-[160px] rounded-lg bg-primary text-white text-sm font-bold h-12 hover:bg-primary/90 shadow-[0_0_15px_rgba(23,161,207,0.3)] flex items-center justify-center gap-2 transition-all">
                Next Step
